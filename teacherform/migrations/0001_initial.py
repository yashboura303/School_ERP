# Generated by Django 2.2.5 on 2019-12-05 11:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='teacherform.Employee')),
                ('photo', models.FileField(upload_to='uploads/emp/photograph')),
                ('qualificationDocs', models.FileField(upload_to='uploads/emp/qualificationDocs')),
