...
def route_register(request):
    if request.method == "POST":
        ...
        vehicle = Vehicle.objects.get(id=vehicle_id)
        Routes.objects.create(vehicle=vehicle, route_code=route_code, start_place=start_place, end_place=end_place, shift_time=shift, stoppage_names=stoppage_name, stoppage_id= stoppage_id, remarks=remarks, route_distance=route_distance, longitude=longitude, lattitude=lattitude)
